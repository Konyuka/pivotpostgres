...
## My Role
Developed, maintained and client support for the Pivot HRM HRM Laravel app since the last three years, contributing to its ongoing success and functionality. The app is designed to streamline human resource management processes and enhance organizational efficiency.
...
## Credits 
- #### Contributors : [Michael Saiba](https://github.com/Konyuka) <small><i>[January, 2021 - Present]</i></small>
